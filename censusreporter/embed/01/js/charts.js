...
function Chart(options) {
    ...
    chart.fillEmbedCode = function(textarea, align) {
        ...
        var embedCode = [
            '<iframe id="'+embedID+'" class="census-reporter-embed" src="http://embed.wazimap.co.za/01/iframe.html?'+querystring+'" frameborder="0" width="100%" height="300" style="margin: 1em; max-width: '+embedWidth+'px;' + embedAlign + '"></iframe>',
            '\n<script src="http://embed.wazimap.co.za/01/js/embed.chart.make.js"></script>'
        ].join('');
