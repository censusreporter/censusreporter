console.log("tilelayer.js is deprecated. Please switch to cr-leaflet.js");
CensusReporter = {}
...
CensusReporter.SummaryLevelLayer = CensusReporter.GeoJSONLayer.extend({
    ...
    initialize: function (summary_level, options, geojsonOptions) {
        ...
        var url = 'https://censusapi.datadrivendetroit.org:1443/1.0/geo/tiger2017/tiles/' + summary_level + '/{z}/{x}/{y}.geojson';
